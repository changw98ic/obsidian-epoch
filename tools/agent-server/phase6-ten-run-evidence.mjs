...
const PHASE6_SCENARIO_PROTOCOL = Object.freeze([
  ...
  { scenarioTag: "medium-prepared-tactical", taskType: "tactical_objective" },
  { scenarioTag: "medium-borderline-escort", taskType: "escort_and_protection" },
  { scenarioTag: "medium-mismatched-preserve", taskType: "resource_preservation" },
  { scenarioTag: "high-prepared-high-value", taskType: "high_value_objective" },
  { scenarioTag: "high-underprepared-evacuation", taskType: "survival_evacuation" },
