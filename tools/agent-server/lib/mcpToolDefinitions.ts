...
const MCP_TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description: "Submit a natural-language journey intention. The server maps it only to a current server-issued action option; Game Core alone decides legality, outcome, reward and world changes.",
    inputSchema: objectSchema({
      journeyId: { type: "string" },
      sceneId: { type: "string" },
      episodeId: { type: "string" },
  ...
  },
  {
    ...
    description: "Submit natural-language intent and return the bounded authoritative result without exposing the internal action option ID.",
    inputSchema: objectSchema({
      journeyId: { type: "string" },
      sceneId: { type: "string" },
      episodeId: { type: "string" },
  ...
  {
    name: "obsidian_epoch.transition_to_gm",
    title: "Transition journey to GM mode",
    description: "Transition an active journey to GM (Game Master) freeform mode. In GM mode, the player acts freely using natural language instead of choosing from preset actions.",
    inputSchema: objectSchema({
      journeyId: { type: "string" },
      recoveryCode: { type: "string" },
      localSecret: { type: "string" },
      idempotencyKey: { type: "string" },
    }, ["journeyId", "idempotencyKey"]),
  },
  {
    name: "obsidian_epoch.journey_gm_act",
    title: "GM mode free action",
    ...
    inputSchema: objectSchema({
      ...
      localSecret: { type: "string" },
      idempotencyKey: { type: "string" },
    }, ["journeyId", "narrative", "idempotencyKey"]),
  },
  {
    name: "obsidian_epoch.settle_gm_journey",
    title: "Settle GM journey",
    description: "Settle a completed GM-mode journey. Transitions the journey to settling state and returns the settlement result.",
    inputSchema: objectSchema({
      journeyId: { type: "string" },
      recoveryCode: { type: "string" },
      localSecret: { type: "string" },
